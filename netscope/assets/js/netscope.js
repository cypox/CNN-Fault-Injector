...
module.exports = Renderer = (function() {
  ...
  Renderer.prototype.insertNode = function(layers) {
    ...
    nodeDesc = {
      ...
      label: nodeLabel,
      "class": nodeClass,
      resilience: baseNode.attribs.resilience,
      layers: layers,
      rx: 5,
      ry: 5
    };
  ...
  Renderer.prototype.render = function() {
    ...
    return svgGroup.selectAll("g.node").each(function(nodeKey) {
      if (that.graph._nodes[nodeKey].resilience == undefined) {
        hueValue = 250;
      } else {
        hueValue = that.graph._nodes[nodeKey].resilience * 250;
      }
      $(this).attr('style', 'fill: hsl(' + hueValue + ', 100%, 50%);');
      var position;
