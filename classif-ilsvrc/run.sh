...
do
  ...
  echo "./fault-injector $NETWORKS/$1/$1_quantized_test.prototxt $NETWORKS/$1/$1_finetuned.caffemodel $NETWORKS/$1/$1'_parsed' $DATASET $a 1000 > outputs/n$a-output-$1;"
  ./fault-injector $NETWORKS/$1/$1_quantized_test.prototxt $NETWORKS/$1/$1_finetuned.caffemodel $NETWORKS/$1/$1'_parsed' $DATASET $a 1000 > outputs/n$a-output-$1;
done
