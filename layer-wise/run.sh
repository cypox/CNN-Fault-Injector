...
do
  ...
  ./fault-injector $NETWORKS/$1/$1_quantized_test.prototxt $NETWORKS/$1/$1_finetuned.caffemodel $NETWORKS/$1/$1'_parsed' $DATASET $a $MAXITER $LAYER > outputs/n$a-output-$1;
done
