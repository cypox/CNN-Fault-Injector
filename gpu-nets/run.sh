...
export DATASET=/media/aiembed/cf11bc1b-0f02-4383-ad36-da07690b0deb/ilsvrc
...
do
  ...
  echo "./fault-injector $NETWORKS/$1/$1_quantized_test.prototxt $NETWORKS/$1/$1_finetuned.caffemodel $NETWORKS/$1/$1'_parsed' $DATASET $a $MAXITER > outputs/n$a-output-$1;"
